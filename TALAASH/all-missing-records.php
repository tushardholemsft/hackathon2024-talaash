...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container mt-5">
            <p class="text-center fs-5 text-bold">All Unidentified Cases</p>
                        ...
                        echo
                            ...
                            <div class="card h-100">
                                <div class="row g-0 user-details">
                                    <div class="col-md-4">
<img src="./media/images/user/' . htmlspecialchars($person['photo_url']) . '" loading="lazy" class="img-fluid rounded-start" alt="' . htmlspecialchars($person['name']) . '" style="object-fit: contain; width: auto; height: auto;">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body ps-5">
                                            ...
                                            <button class="btn btn-success mark-found-btn mt-3" data-person-id="' . htmlspecialchars($person['FIR_number']) . '" onclick="setAsFound(event)">
                                                Mark as Found
                                            </button>
                                            <button class="btn btn-danger delete-record-btn mt-3 ms-2" data-person-id="' . htmlspecialchars($person['FIR_number']) . '" onclick="deleteRecord(event)">
                                                Delete Record
                                            </button>
                                        </div>
                                    </div>
