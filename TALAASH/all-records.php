...
<body>
    ...
    <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item how-to-use">
                            <a class="nav-link" href="./upload.php">Add Missing Reports</a>
                        </li>
                        <li class="nav-item how-to-use">
                        ...
                        <li class="nav-item notification">
                            <i class="bi bi-bell" data-bs-toggle="popover" data-bs-placement="bottom"
                              ...
                              <div class='d-flex align-items-center mb-2'>
                                <div>
                                  <p class='mb-0'>You have a new message from John Doe.</p>
        ...
        <div class="container mt-5">
            <p class="text-center fs-5 text-bold">All Missing Reports</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="./media/images/user/' . htmlspecialchars($person['photo_url']) . '" loading="lazy" class="card-img-top" alt="' . htmlspecialchars($person['name']) . '">
                    <div class="card-body">
