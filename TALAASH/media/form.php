                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto nav-underline">
                        <li class="nav-item how-to-use">
                            <a class="nav-link active" aria-current="page" href="./upload.php">Upload Report</a>
                        </li>
                        <li class="nav-item how-to-use">
                            <a class="nav-link" href="./all-missing-records.php">Missing Case</a>
                        </li>
                        <li class="nav-item how-to-use">
                            <a class="nav-link" href="./all-found-records.php">Solved Case</a>
                        </li>
